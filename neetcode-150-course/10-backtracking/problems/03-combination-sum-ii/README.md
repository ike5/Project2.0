...
1. Sort. Skip duplicates: at the same recursion depth, if the previous element was the same value and we skipped it, skip this one too.

## Solution

See [`../../solutions/03-combination-sum-ii/`](../../solutions/03-combination-sum-ii/) for the Python and Java 21 solutions and a step-by-step walkthrough.
