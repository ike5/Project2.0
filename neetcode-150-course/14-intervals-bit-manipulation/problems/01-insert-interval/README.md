...
1. Three sections: before, overlapping, after. Merge the overlapping section with newInterval.

## Solution

See [`../../solutions/01-insert-interval/`](../../solutions/01-insert-interval/) for the Python and Java 21 solutions and a step-by-step walkthrough.
